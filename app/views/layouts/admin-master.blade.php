    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <li><a href="{{{ action('HomeController@showInventory') }}}"><i class="fa fa-archive"></i> Inventory</a></li>
                <li><a href="{{{ action('HomeController@showVendors') }}}"><i class="fa fa-briefcase"></i> Vendors</a></li>
