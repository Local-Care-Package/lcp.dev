	...
	<div class="row">
		<div class="container">
			<ul>
				...
				<li class="admin-action"><a class="sort-orders btn btn-sm" href="?show=all">All Orders</a></li>
				<li class="admin-action"><a class="sort-orders btn btn-sm" href="?show=newOrders">New Orders</a></li>
				<li class="admin-action"><a class="sort-orders btn btn-sm" href="?show=inPackage">In Package Orders</a></li>
				<li class="admin-action"><a class="sort-orders btn btn-sm" href="?show=delivered">Delivered Orders</a></li>
			</ul>
		</div>
	<div>
@stop
